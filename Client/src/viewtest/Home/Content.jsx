...
function Content() {
  ...
  return (
    <div className="content" id="content">
      <h1 className="content__text">Điện thoại dành cho bạn</h1>
      ...
      <div className="content__list">
        {!hasProducts &&
          <div className='not__product'>
            ...
            <h3 className='not__product-text'>Hiện tại không có điện thoại cần tìm</h3>
          </div>}
            ...
            <div className='content__list-child-detail'>
              <div className='content__list-child-detail-evaluate'>
                ...
                <div className='content__list-child-detail-evaluate-usage'>
                  <i><FaCarRear /></i>
                  <p className='content__list-child-detail-evaluate-usage-text'>{car.usage} lượt mua</p>
                </div>
              </div>
