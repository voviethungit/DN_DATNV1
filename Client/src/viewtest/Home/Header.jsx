  ...
  return (
    <div className='header' id='header'>
      ...
      <ul className='header__page'>
        {isLoggedIn ? (
          <Link to="/ve-xe-tot" className='header__page-item login__page'>Về Mobile Hub
          </Link>
        ) : (
          <>
            <Link to="/ve-xe-tot" className='logout-item-page'>Về Mobile Hub
            </Link>
        ...
        {isLoggedIn ? (
          ...
          <div className='header__page-item-login'>
            {/* <BeatLoader
              ...
              /> */}
            {/* <Link to="/chuyen-di-cua-toi" className='header__page-item'>Lịch Sử Mua</Link> */}
            ...
            >
              ...
              <div style={{ display: isBell ? 'none' : 'block' }} className='header__page-item-login-bell-list'>
                ...
                <p className='header__page-item-login-bell-list-text'>Hiện tại bạn chưa có thông báo nào từ Mobile Hub
                </p>
